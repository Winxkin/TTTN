// -----------------------------------------------------------------------------
// $Id: intc2g_u2_regif.cpp,v 1.6 2018/12/03 10:08:20 huepham Exp $
//
...
//
// Input file : INTC2G_U2/intc2g_u2_regif.txt
////////////////////////////////////////////////////////////////////////////////
// %MODULE INTC2G_U2
// 
...
//     %%REG       INTC2GOVFCLR        INTC2GOVFCLR       32        8|16|32   32          0x0         R|W1:0      0x00000000     -               -               -               TRUE        W
...
//     %%REG       INTC2GMPID          INTC2GMPID         32        8|16|32   32          0x40        R|W         0x00000000     0               15              0x4             TRUE        -
...
//     %%REG       INTC2GPROT_         INTC2GPROT_        32        8|16|32   32          0x100       R|W         0x00000000     32              2047            0x4             TRUE        -
//     
// 
// 
    ...
    #endif
{
    ...
    for(uint i = 0; i < mNumOfCh; i++) {
        ...
        INTC2GPROT_      [mFactorIndexINTC2GPROT_[i]] = new vpcl::re_register((0x0100) + 4*(mFactorIndexINTC2GPROT_[i]-32), this, str_tmp.str(), name.c_str());
    }
    ...
    for(uint i = 0; i < mNumOfCh;      i++) {
        mRegMap[(0x0100)     + (mFactorIndexINTC2GPROT_[i]-32)*4] = index;
        mRegMap[(0x0100 + 1) + (mFactorIndexINTC2GPROT_[i]-32)*4] = index;
        mRegMap[(0x0100 + 2) + (mFactorIndexINTC2GPROT_[i]-32)*4] = index;
        mRegMap[(0x0100 + 3) + (mFactorIndexINTC2GPROT_[i]-32)*4] = index++;
    }
    mTotalRegNum = index;
    ...
    #endif
    mCurReg = mRegArray[index++] = new SRegList(INTC2GOVFCLR       , mCurReg, 0,  4,      "32", "8|16|32");
    ...
    for(uint i = 0; i < emNUM_INTC2GMPID       ; i++) mCurReg = mRegArray[index++] = new SRegList(INTC2GMPID         [i], mCurReg, i,  4,      "32", "8|16|32");
...
void Cintc2g_u2_regif::UpdateLocalVal(cuint addr)
{
    ...
    if ((0x0100 <= addr) && (addr <= (0x0100)+(4*2015)) && ((addr-0x0100)%4 == 0)) {
        uint i = (addr - 0x0100)/4 + 32;
